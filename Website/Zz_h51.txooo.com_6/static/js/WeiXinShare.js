var wxShare = {
    ...
    //分享异步代码
    init: function () {
        var data = '?callbackparam=wxShare.jsonpSuccess&selfurl=' + encodeURIComponent(window.location.href) + '&accountId=' + wxShare.accountId + '&accountType=' + wxShare.accountType;
        ...
        wx.ready(function () {
            ...
            wx.getNetworkType({
                success: function (res) {
                    ...
                    wxShare.isNetworkType(res.networkType); // 返回网络类型2g，3g，4g，wifi
                }
            });
        });
    ...
    wxSetImg: function (sizeType, sourceType) {
        wx.chooseImage({
